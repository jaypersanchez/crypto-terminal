...
X = df[['date_ordinal']]  # Independent variable (date as ordinal)
...
# Trend line
fig.add_trace(go.Scatter(x=df['date'], y=df['trend'], mode='lines', name='Trend Line', line=dict(color='green', width=2, dash='dash')))
