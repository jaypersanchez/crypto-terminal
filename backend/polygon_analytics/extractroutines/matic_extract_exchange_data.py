...
existing_df = pd.read_csv('../../data/matic_yearly_extract_exchange_data.csv')
...
df_grouped.to_csv('../../data/matic_yearly_extract_exchange_data.csv', mode='a', header=False, index=False)

print("Data appended successfully to '../../data/matic_yearly_extract_exchange_data.csv'.")
